  ...
  return (
    <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
        ...
        <div className ='w-[90%] flex items-start justify-start flex-col gap-[10px] mt-[50px]'>
            ...
            <input type="text" id='Title'  className = 'w-[90%] h-[40px] border-[2px] rounded-lg text-[18px] px-[20px]  '  
        ...
        <div className ='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
            ...
            <textarea name="" id="des" className = 'w-[90%] h-[80px] border-[2px] rounded-lg text-[18px] px-[20px]  '  
        ...
        <div className ='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
            ...
            <input type="number" id='rent'  className = 'w-[90%] h-[40px] border-[2px] rounded-lg text-[18px] px-[20px]  '  
            required onChange={(e)=>setRent(e.target.value)} value={rent} placeholder='RS.____/-day'/>
        </div>

        <div className ='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
            <label htmlFor="city" className='text-[20px]'>City</label>
            <input type="text" id='city'  className = 'w-[90%] h-[40px] border-[2px] rounded-lg text-[18px] px-[20px]  '  
        ...
        <div className ='w-[90%] flex items-start justify-start flex-col gap-[10px] '>
            ...
            <input type="text" id='landmark'  className = 'w-[90%] h-[40px] border-[2px] rounded-lg text-[18px] px-[20px]  '  
            required onChange={(e)=>setLandmark(e.target.value)} value={landmark} />
        </div>

        <button className='px-[50px] py-[10px] bg-red-500 text-[white] text-[18px] md:px-[100px] rounded-lg cursor-pointer' > 
            Next </button>
